...
/* ============================================================
   UBX STARTUP CONFIGURATION PACKETS
   ============================================================ */

static const uint8_t UBX_Enable_PVT[] = {
    0xB5,0x62,0x06,0x8A,0x09,0x00,0x00,0x01,0x00,0x00,
    0x07,0x00,0x91,0x20,0x01,0x53,0x48
};

static const uint8_t UBX_Enable_TIMEGPS[] = {
    0xB5,0x62,0x06,0x8A,0x09,0x00,0x00,0x01,0x00,0x00,
    0x48,0x00,0x91,0x20,0x01,0x94,0x8D
};

static const uint8_t UBX_Enable_NavIC[] = {
    0xB5,0x62,0x06,0x8A,0x09,0x00,0x00,0x01,0x00,0x00,
    0x26,0x00,0x31,0x10,0x01,0x02,0xA3,

    0xB5,0x62,0x06,0x8B,0x08,0x00,0x00,0x00,0x00,0x00,
    0xFF,0xFF,0x31,0x00,0xC8,0xEC,

    0xB5,0x62,0x06,0x8B,0x08,0x00,0x00,0x00,0x00,0x00,
    0x26,0x00,0x31,0x10,0x00,0x9B
};

static const uint8_t UBX_Set_Timepulse[] = {
    /* FULL BYTE STREAM EXACTLY AS YOU PROVIDED */
    0xB5,0x62,0x06,0x8A,0x5F,0x00,0x00,0x07,0x00,0x00,0x01,0x00,
    0x05,0x30,0x32,0x00,0x23,0x00,0x05,0x20,0x00,0x30,0x00,0x05,
    0x20,0x01,0x07,0x00,0x05,0x10,0x01,0x09,0x00,0x05,0x10,0x01,
    0x06,0x00,0x05,0x40,0x00,0x00,0x00,0x00,0x0B,0x00,0x05,0x10,
    0x01,0x02,0x00,0x05,0x40,0x40,0x42,0x0F,0x00,0x35,0x00,0x05,
    0x20,0x01,0x04,0x00,0x05,0x40,0x00,0x00,0x00,0x00,0x08,0x00,
    0x05,0x10,0x01,0x03,0x00,0x05,0x40,0x40,0x42,0x0F,0x00,0x05,
    0x00,0x05,0x40,0xA0,0x86,0x01,0x00,0x0A,0x00,0x05,0x10,0x01,
    0x0C,0x00,0x05,0x20,0x01,0xDA,0xA5,

    /* Remaining packets */
    
};
static const uint8_t UBX_Save_All_To_FLASH[] = {
    0xB5,0x62,0x06,0x09,0x0D,0x00,
    0x00,0x00,0x00,0x00,   // clearMask
    0xFF,0xFF,0x00,0x00,   // saveMask = ALL
    0x00,0x00,0x00,0x00,   // loadMask
    0x02,                  // deviceMask = FLASH
    0x1C,0xAA              // checksum
};
static const uint8_t UBX_Save_All_To_BBR[] = {
    0xB5,0x62,0x06,0x09,0x0D,0x00,
    0x00,0x00,0x00,0x00,   // clearMask
    0xFF,0xFF,0x00,0x00,   // saveMask = ALL
    0x00,0x00,0x00,0x00,   // loadMask
...
int main(void)
{
    ...
    /* ===== UBLOX CONFIGURATION AT STARTUP ===== */

    SysCtlDelay(sysClock / 10);   // ~100 ms (UART + GNSS ready)

    UBX_Send(UBX_Enable_PVT, sizeof(UBX_Enable_PVT));
    ...
    UBX_Send(UBX_Set_Timepulse, sizeof(UBX_Set_Timepulse));
    SysCtlDelay(sysClock / 10);

    UBX_Send(UBX_Save_All_To_FLASH, sizeof(UBX_Save_All_To_FLASH));
    SysCtlDelay(sysClock / 5);   // ~200 ms (Flash write time)

    UBX_Send(UBX_Save_All_To_BBR, sizeof(UBX_Save_All_To_BBR));
    SysCtlDelay(sysClock / 10);
